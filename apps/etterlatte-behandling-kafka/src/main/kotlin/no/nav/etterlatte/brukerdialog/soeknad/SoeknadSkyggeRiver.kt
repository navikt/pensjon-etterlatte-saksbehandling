...
/** Skyggekjøring: lytter på samme event som NySoeknadRiver, men muterer ingenting. Gated bak toggle (default av). */
internal class SoeknadSkyggeRiver(
    ...
    override fun haandterPakke(
        ...
        try {
            ...
            logger.error("Skyggekjøring: kunne ikke legge søknad i prosessering-kø", e)
        }
    }
}
