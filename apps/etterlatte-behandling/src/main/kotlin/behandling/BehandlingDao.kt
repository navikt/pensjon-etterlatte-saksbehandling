...
import no.nav.etterlatte.libs.common.tidspunkt.tilTimestamp
...
private fun LocalDateTime.somTimestamp() = tilTimestamp()

private fun ResultSet.somLocalDateTime(kolonne: String) = getTimestamp(kolonne).toLocalDateTime()
