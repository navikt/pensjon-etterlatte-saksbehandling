...
internal fun Behandling.toStatistikkBehandling(
    ...
    StatistikkBehandling(
        ...
        innsender = persongalleri.innsender?.value,
        soeker = persongalleri.soeker.value,
        gjenlevende = persongalleri.gjenlevende.map { it.value },
        avdoed = persongalleri.avdoed.map { it.value },
        soesken = persongalleri.soesken.map { it.value },
        status = status,
        behandlingType = type,
