...
class EtteroppgjoerSvarfristUtloeptJob(
    private val etteroppgjoerSvarfristUtloeptJobService: EtteroppgjoerSvarfristUtloeptJobService,
    ...
    private var jobContext: Context =
        Context(
            Self(etteroppgjoerSvarfristUtloeptJobService::class.java.simpleName),
    ...
    override fun schedule(): Timer {
        ...
        return fixedRateCancellableTimer(
            ...
            if (erLeader()) {
                etteroppgjoerSvarfristUtloeptJobService.startKjoering(jobContext)
            }
        }
    }
}
