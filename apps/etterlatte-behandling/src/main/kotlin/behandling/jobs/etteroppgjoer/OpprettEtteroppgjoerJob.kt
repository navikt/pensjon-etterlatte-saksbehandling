...
class OpprettEtteroppgjoerJob(
    private val opprettEtteroppgjoerJobService: OpprettEtteroppgjoerJobService,
    ...
    private var jobContext: Context =
        Context(
            Self(opprettEtteroppgjoerJobService::class.java.simpleName),
    ...
    override fun schedule(): Timer {
        ...
        return fixedRateCancellableTimer(
            ...
            if (erLeader()) {
                opprettEtteroppgjoerJobService.startKjoering(jobContext)
            }
        }
    }
}
