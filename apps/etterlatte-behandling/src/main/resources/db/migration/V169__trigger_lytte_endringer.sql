...
BEGIN
    IF TG_OP = 'INSERT'
    THEN
        INSERT INTO t_history (tabell, skjema, operation, foer)
        VALUES (TG_RELNAME, TG_TABLE_SCHEMA, TG_OP, row_to_json(NEW));
        RETURN NEW;
    ELSIF TG_OP = 'UPDATE'
    THEN
        INSERT INTO t_history (tabell, skjema, operation, foer, etter)
        VALUES (TG_RELNAME, TG_TABLE_SCHEMA, TG_OP,
                row_to_json(NEW), row_to_json(OLD));
        RETURN NEW;
    ELSIF TG_OP = 'DELETE'
    THEN
        INSERT INTO t_history (tabell, skjema, operation, etter)
