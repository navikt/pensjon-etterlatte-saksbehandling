...
class AktivitetspliktDaoTest(
    ...
    fun `skal hente aktiviteter for behandling`() {
        ...
        val nyAktivtet = opprettAktivitet(sakSkrivDao.opprettSak("Person1", SakType.OMSTILLINGSSTOENAD, Enhet.defaultEnhet))
    ...
    fun `skal opprette ny aktivetet`() {
        val behandlingId = UUID.randomUUID()
        val nyAktivitet = opprettAktivitet(sakSkrivDao.opprettSak("Person1", SakType.OMSTILLINGSSTOENAD, Enhet.defaultEnhet))
