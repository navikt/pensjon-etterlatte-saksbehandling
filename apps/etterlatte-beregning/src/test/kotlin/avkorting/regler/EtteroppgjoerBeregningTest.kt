...
import no.nav.etterlatte.avkorting.regler.differanse
import no.nav.etterlatte.avkorting.regler.nyBruttoStoenad
import no.nav.etterlatte.avkorting.regler.sumNyBruttoStoenad
import no.nav.etterlatte.avkorting.regler.sumUtbetaltStoenad
import no.nav.etterlatte.avkorting.regler.utbetaltStoenad
...
class EtteroppgjoerBeregningTest {
    ...
    fun `finne differanse mellom ny brutto stoenad og utbetalt stoenad`() {
        val diff = differanse.anvend(grunnlag(listOfUtbetaltStoenad(), listOfBruttoStoenad()), regelPeriode).verdi
        diff shouldBe -1100
