...
internal class BehandlingTest {
    ...
    fun `MapAvdoed mapper til Avdoed`() {
        ...
        assertEquals(Avdoed("Frisk Mellomstor Gaupe", LocalDate.of(2022, 8, 17)), grunnlag.mapAvdoede())
    }
    ...
    fun `map med dobbelnavn og bindestrek`() {
        ...
        assertEquals(Avdoed("Riv-Jern Kul-Kar Badeball-Sommer", LocalDate.of(2022, 8, 17)), grunnlag.mapAvdoede())
    }
