...
internal class NyNotatServiceTest(
    ...
    fun `Hent og opprett notat for sak fungerer`() {
        ...
        coEvery { behandlingServiceMock.hentSak(any(), any()) } returns Sak("ident", SakType.BARNEPENSJON, sakId, Enhet.PORSGRUNN)
    ...
    fun `Journalfoer notat`() {
        ...
        val sak = Sak("ident", SakType.BARNEPENSJON, sakId, Enhet.PORSGRUNN)
