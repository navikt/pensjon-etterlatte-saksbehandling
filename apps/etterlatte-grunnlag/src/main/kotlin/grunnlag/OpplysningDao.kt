...
class OpplysningDao(
    ...
    fun hentAlleGrunnlagForSak(sakId: no.nav.etterlatte.libs.common.sak.SakId): List<GrunnlagHendelse> =
        connection.use {
            it
                .prepareStatement(
                    """
    ...
    fun finnHendelserIGrunnlag(sakId: no.nav.etterlatte.libs.common.sak.SakId): List<GrunnlagHendelse> =
        connection.use {
            it
                .prepareStatement(
                    """
