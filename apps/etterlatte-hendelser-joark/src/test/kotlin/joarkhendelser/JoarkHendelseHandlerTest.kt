...
internal class JoarkHendelseHandlerTest {
    ...
    inner class HendelserSkalBehandles {
        ...
        fun `Journalpost mottatt skal behandles hvis ikke ferdigstilt`(sakType: SakType) {
            ...
            coEvery { pdlTjenesterKlientMock.hentAdressebeskyttelse(any()) } returns AdressebeskyttelseGradering.UGRADERT
            ...
            coVerify(exactly = 1) {
                ...
                pdlTjenesterKlientMock.hentAdressebeskyttelse(ident)
