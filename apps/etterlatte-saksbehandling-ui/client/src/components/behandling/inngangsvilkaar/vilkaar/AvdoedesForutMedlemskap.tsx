  ...
  return (
    <>
        ...
        <VilkaarColumn>
          ...
          <div><strong>Bostedsardresse</strong></div>
          <div>Veien 123</div>
          <div>0088 Oslo</div>
        ...
        <VilkaarColumn>
          ...
          <div><strong>Arbeidsperioder</strong></div>
        ...
        <VilkaarColumn>
          ...
          <div><strong>Opphold utenfor Norge etter fylte 16 år</strong></div>
          <div>Ja</div>
        ...
        <VilkaarColumn>
          ...
          <div><strong>Mottok pensjon/uføretrygd</strong></div>
