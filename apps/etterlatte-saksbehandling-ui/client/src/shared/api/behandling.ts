...
export const lagreUtenlandstilknytning = async (args: {
  behandlingId: string
  begrunnelse: string
  svar: string
}): Promise<ApiResponse<IUtenlandstilknytning>> => {
  return apiClient.post(`/behandling/${args.behandlingId}/utenlandstilknytning`, {
    utenlandstilknytningType: args.svar,
    begrunnelse: args.begrunnelse,
  })
}
...
export const lagreBoddEllerArbeidetUtlandet = async (args: {
  ...
  return apiClient.post(`/behandling/${args.behandlingId}/boddellerarbeidetutlandet`, {
    ...
    norgeErBehandlendeland: args.norgeErBehandlendeland,
