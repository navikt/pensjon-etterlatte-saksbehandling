...
import { SoekPerson } from '~components/person/journalfoeringsoppgave/journalpost/modal/AvansertSoek'
...
export const soekPerson = async (soekPerson: SoekPerson): Promise<ApiResponse<SoekPerson>> =>
