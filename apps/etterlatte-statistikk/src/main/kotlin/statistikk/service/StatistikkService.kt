...
class StatistikkService(
    ...
    private fun vedtakshendelseTilSakRad(
        ...
        return SakRad(
            id = -1,
            referanseId = vedtakInnhold.forenkletRevurderingInfo.id,
            sakId = vedtak.sak.id,
            ...
            type = vedtakInnhold.forenkletRevurderingInfo.type.name,
    ...
    private fun vedtakTilStoenadsrad(
        ...
        return StoenadRad(
            ...
            anvendtSats = "",
            behandlingId = vedtakInnhold.forenkletRevurderingInfo.id,
            sakId = vedtak.sak.id,
