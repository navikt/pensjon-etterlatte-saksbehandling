...
class StatistikkService(
    ...
    private fun vedtakshendelseTilSakRad(
        ...
        return SakRad(
            id = -1,
            referanseId = vedtakInnhold.behandlingLagretHosVedtak.id,
            sakId = vedtak.sak.id,
            ...
            type = vedtakInnhold.behandlingLagretHosVedtak.type.name,
    ...
    private fun vedtakTilStoenadsrad(
        ...
        return StoenadRad(
            ...
            anvendtSats = "",
            behandlingId = vedtakInnhold.behandlingLagretHosVedtak.id,
            sakId = vedtak.sak.id,
