...
internal class OppdragForKonsistensavstemmingSerializer :
    ...
    override fun serialize(
        ...
        gen.writeNumberProperty("value", value.sakId.value)
        gen.writeEndObject()

        gen.writeStringProperty("sakType", value.sakType.name)

        gen.writeObjectPropertyStart("fnr")
        gen.writeStringProperty("value", value.fnr.value)
        gen.writeEndObject()
...
internal class OppdragslinjeForKonsistensavstemmingSerializer :
    ...
    override fun serialize(
        ...
        gen.writeNumberProperty("value", value.id.value)
        gen.writeEndObject()
