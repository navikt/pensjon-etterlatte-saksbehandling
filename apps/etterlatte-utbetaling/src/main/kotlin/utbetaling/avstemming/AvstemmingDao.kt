...
class AvstemmingDao(private val dataSource: DataSource) {
    ...
    private fun toKonsistensavstemming(row: Row) = Konsistensavstemming(
        ...
        opprettet = row.sqlTimestamp("opprettet").toTidspunkt(),
        avstemmingsdata = row.string("avstemmingsdata"),
        loependeFraOgMed = row.sqlTimestamp("loepende_fom").toTidspunkt(),
        opprettetTilOgMed = row.sqlTimestamp("opprettet_tom").toTidspunkt(),
    ...
    private fun toGrensesnittavstemming(row: Row) = Grensesnittavstemming(
        ...
        periode = Avstemmingsperiode(
            fraOgMed = row.sqlTimestamp("periode_fra").toTidspunkt(),
            til = row.sqlTimestamp("periode_til").toTidspunkt()
        ),
