...
import no.nav.etterlatte.vedtaksvurdering.erVedtakMedEtterbetaling
...
class VedtakFiksBehandlingService(
    ...
    private val logger = LoggerFactory.getLogger(VedtakFiksBehandlingService::class.java)
