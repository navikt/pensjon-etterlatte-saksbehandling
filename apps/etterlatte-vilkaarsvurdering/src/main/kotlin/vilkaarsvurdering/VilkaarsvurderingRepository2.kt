...
interface VilkaarsvurderingRepository2 {
...
class VilkaarsvurderingRepository2Impl(private val ds: DataSource) : VilkaarsvurderingRepository2 {
    ...
    private object Queries {
        const val lagreVilkaarsvurdering = """
            INSERT INTO vilkaarsvurdering_v2(id, behandling_id, virkningstidspunkt, sak_id, grunnlag_versjon) 
        ...
        const val hentVilkaarsvurdering = """
            ...
            FROM vilkaarsvurdering_v2 WHERE behandling_id = :behandling_id
        """
        ...
        const val slettVilkaarsvurdering = "DELETE FROM vilkaarsvurdering_v2 WHERE sak_id = :sak_id"
    }
}