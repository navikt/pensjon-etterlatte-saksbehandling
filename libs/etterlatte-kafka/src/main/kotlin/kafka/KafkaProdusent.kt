...
fun KafkaConfig.standardProducer(topic: String): KafkaProdusent<String, String> = KafkaProdusentImpl(KafkaProducer(producerConfig(), StringSerializer(), StringSerializer()), topic)
fun KafkaConfig.rapidsAndRiversProducer(topic: String): KafkaProdusent<String, JsonMessage> = KafkaProdusentImpl(KafkaProducer(producerConfig(), StringSerializer(), JsonMessageSerializer()), topic)
