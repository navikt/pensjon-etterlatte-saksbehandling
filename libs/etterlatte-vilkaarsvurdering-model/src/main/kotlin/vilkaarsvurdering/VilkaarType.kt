...
enum class VilkaarType(
    ...
    BP_FORMAAL_2024(10),
    BP_DOEDSFALL_FORELDER_2024(100),
    BP_YRKESSKADE_AVDOED_2024(200),
    BP_ALDER_BARN_2024(300),
    BP_ALDER_BARN_UNNTAK_YS_GAMMELT_REGELVERK(301),
    BP_FORTSATT_MEDLEMSKAP_2024(400),
    BP_FORTSATT_MEDLEMSKAP_UNNTAK_FORELDRE_MINST_20_AAR_SAMLET_BOTID_2024(401),
    BP_FORTSATT_MEDLEMSKAP_UNNTAK_AVDOED_MINDRE_20_AAR_BOTID_TRE_POENGAAR_2024(402),
    BP_FORTSATT_MEDLEMSKAP_UNNTAK_YRKESSKADE_2024(403),
    BP_FORTSATT_MEDLEMSKAP_UNNTAK_FORELDRELOEST_BARN_I_KULL_MEDLEM_TRYGDEN_2024(404),
    BP_VURDERING_AV_EKSPORT_2024(450),
    BP_FORUTGAAENDE_MEDLEMSKAP_2024(500),
    BP_FORUTGAAENDE_MEDLEMSKAP_UNNTAK_AVDOED_IKKE_FYLT_26_AAR_2024(501),
    BP_FORUTGAAENDE_MEDLEMSKAP_UNNTAK_AVDOED_MEDLEM_ETTER_16_AAR_2024(502),
    BP_FORUTGAAENDE_MEDLEMSKAP_UNNTAK_AVDOED_HALV_MINSTEPENSJON_2024(503),
    BP_FORUTGAAENDE_MEDLEMSKAP_UNNTAK_AVDOED_AVTALEFESTET_PENSJON_2024(504),
    BP_FORUTGAAENDE_MEDLEMSKAP_UNNTAK_AVDOED_YRKESSKADE_2024(505),
    BP_FORUTGAAENDE_MEDLEMSKAP_UNNTAK_AVDOED_LOVFESTET_PENSJONSORDNING_2024(506),
    BP_FORUTGAAENDE_MEDLEMSKAP_EOES_2024(600),

    // Omstillingsstønad
    OMS_ETTERLATTE_LEVER(90),
    OMS_DOEDSFALL(100),
    OMS_OEVRIGE_VILKAAR(105),
    ...
    OMS_VURDERING_AV_EKSPORT(450),
    OMS_RETT_UTEN_TIDSBEGRENSNING(500),
