...
enum class VilkaarType(
    val rekkefoelge: Int,
    val tittel: String,
    val gjelderAvdoede: Boolean = false,
) {
    // Barnepensjon gammelt regelverk
    BP_FORMAAL(10, "Lever barnet?"),
    BP_DOEDSFALL_FORELDER(100, "Dødsfall forelder", gjelderAvdoede = true),
    BP_YRKESSKADE_AVDOED(200, "Yrkesskade", gjelderAvdoede = true),
    ...
    BP_FORTSATT_MEDLEMSKAP_UNNTAK_YRKESSKADE(403, "Ja. Dødsfallet skyldes en godkjent yrkes-skade/sykdom", gjelderAvdoede = true),
    ...
    BP_VURDERING_AV_EKSPORT(450, "Vurdering av eksport", gjelderAvdoede = true),
    BP_FORUTGAAENDE_MEDLEMSKAP(500, "Avdødes forutgående medlemskap - Folketrygden", gjelderAvdoede = true),
    ...
    BP_FORUTGAAENDE_MEDLEMSKAP_UNNTAK_AVDOED_YRKESSKADE(
        505,
    ...
    BP_FORUTGAAENDE_MEDLEMSKAP_EOES(600, "Avdødes forutgående medlemskap - EØS/avtaleland", gjelderAvdoede = true),

    // Barnepensjon nytt regelverk
    BP_FORMAAL_2024(10, "Lever barnet?"),
    BP_DOEDSFALL_FORELDER_2024(100, "Dødsfall forelder", gjelderAvdoede = true),
    BP_YRKESSKADE_AVDOED_2024(200, "Yrkesskade", gjelderAvdoede = true),
    ...
    BP_FORTSATT_MEDLEMSKAP_UNNTAK_YRKESSKADE_2024(403, "Ja. Dødsfallet skyldes en godkjent yrkes-skade/sykdom", gjelderAvdoede = true),
    BP_FORTSATT_MEDLEMSKAP_UNNTAK_FORELDRELOEST_BARN_I_KULL_MEDLEM_TRYGDEN_2024(
        404,
        "Ja. Minst ett av barna i et foreldreløst barnekull er medlem i trygden",
    ),
    BP_VURDERING_AV_EKSPORT_2024(450, "Vurdering av eksport", gjelderAvdoede = true),
    BP_FORUTGAAENDE_MEDLEMSKAP_2024(500, "Avdødes forutgående medlemskap - Folketrygden", gjelderAvdoede = true),
    ...
    BP_FORUTGAAENDE_MEDLEMSKAP_EOES_2024(600, "Avdødes forutgående medlemskap - EØS/avtaleland", gjelderAvdoede = true),
