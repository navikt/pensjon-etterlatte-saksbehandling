...
enum class VilkaarType(val rekkefoelge: Int) {
    ...
    OMS_AVDOEDES_MEDLEMSKAP_UNNTAK_YRKESSKADE(304),
    OMS_AVDOEDES_MEDLEMSKAP_UNNTAK_OPPTJENING(305),
    OMS_GJENLEVENDES_MEDLEMSKAP(400),
    OMS_GJENLEVENDES_MEDLEMSKAP_UNNTAK_BOTID(401),
    OMS_GJENLEVENDES_MEDLEMSKAP_UNNTAK_YRKESSKADE(402),
    OMS_GJENLEVENDES_MEDLEMSKAP_UNNTAK_PENSJON(403),
