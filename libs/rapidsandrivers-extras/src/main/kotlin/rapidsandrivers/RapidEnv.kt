...
fun getRapidEnv(kafkaConsumerGroupName: String = Miljoevariabler.systemEnv()[NAIS_APP_NAME]!!.replace("-", "")): Miljoevariabler =
    Miljoevariabler
        .systemEnv()
        .append(RapidKey.KAFKA_CONSUMER_GROUP_ID) { kafkaConsumerGroupName }
