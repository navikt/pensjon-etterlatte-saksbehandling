...
fun Grunnlagsdata<JsonNode>.hentFoedselsnummer() =
    this.hentKonstantOpplysning<Folkeregisteridentifikator>(
        FOEDSELSNUMMER,
    )
...
fun Grunnlagsdata<JsonNode>.hentAdressebeskyttelse() = this.hentKonstantOpplysning<AdressebeskyttelseGradering>(ADRESSEBESKYTTELSE)
