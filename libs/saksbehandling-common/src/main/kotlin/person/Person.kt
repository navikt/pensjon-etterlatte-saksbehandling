...
fun hentRelevantVerge(soeker: List<VergemaalEllerFremtidsfullmakt>?): VergemaalEllerFremtidsfullmakt? {
    val vergeListe = soeker ?: return null
    ...
    return vergerMedRelevantOmfang.first()
}
