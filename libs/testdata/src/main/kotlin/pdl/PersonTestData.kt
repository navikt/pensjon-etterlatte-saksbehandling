...
fun personTestData(
    ...
    bostedsadresse = opplysningsmap.hentBostedsadresse()?.verdi?.let { listOf(it) },
    deltBostedsadresse = opplysningsmap.hentDeltbostedsadresse()?.verdi?.let { listOf(it) },
    kontaktadresse = opplysningsmap.hentKontaktadresse()?.verdi?.let { listOf(it) },
    oppholdsadresse = opplysningsmap.hentOppholdsadresse()?.verdi?.let { listOf(it) },
